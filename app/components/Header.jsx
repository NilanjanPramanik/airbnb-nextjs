...
const MobileSearch = ({setMobileSearch}) => {
  ...
  return (
    <div className="flex flex-col gap-3 h-[100vh] ">
      <XCircleIcon onClick={()=>setMobileSearch(false)} className="w-8 h-8 cursor-pointer" />
      ...
      <div
        ...
        className={`rounded-3xl shadow-lg p-6 flex flex-col gap-2 border border-gray-300/50 ${isWhereActive ? 'opacity-100' : 'opacity-40'}`}
      >
      ...
      <div
        ...
        className={`rounded-3xl shadow-lg p-6 flex gap-2 border border-gray-300/50 justify-between align-middle cursor-pointer ${isWhenActive ? 'opacity-100' : 'opacity-40'}`}
      >
      ...
      <div
        ...
        }  gap-2 border border-gray-300/50 justify-between align-middle cursor-pointer ${isWhoActive ? 'opacity-100' : 'opacity-40'}`}
      >
...
const Header = () => {
  ...
  return (
    <section>
      {isMobileSearch ? (
        <MobileSearch setMobileSearch={setMobileSearch}/>
      ) : (
        <div
